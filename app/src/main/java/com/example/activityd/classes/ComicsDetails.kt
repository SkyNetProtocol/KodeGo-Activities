...
class ComicsDetails (val titleComics: String, val monthPublishedComics: String, val yearPublishedComics: Int,
    ...
    class ComicsIllustrator(val firstNameComicIllustrator: String, val lastNameComicIllustrator: String,
                            val middleNameComicIllustrator: String, val dateOfBirthComicIllustrator: String)
